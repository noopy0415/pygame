...
def main():
    ...
    Ball.paddle_sound = pygame.mixer.Sound("sound/flashing.mp3")  # パドルにボールが衝突した時の効果音取得
    Ball.block_sound = pygame.mixer.Sound("sound/flying_pan.mp3")  # ブロックにボールが衝突した時の効果音取得
    Ball.gameover_sound = pygame.mixer.Sound("sound/badend1.mp3")  # ゲームオーバー時の効果音取得
    # 描画用のスプライトグループ
